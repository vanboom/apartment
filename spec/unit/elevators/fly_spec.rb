require 'spec_helper'
require 'apartment/elevators/fly'

describe Apartment::Elevators::Fly do

  subject(:elevator){ described_class.new(Proc.new{}, :append_string=>"_quantum") }

  describe "#parse_tenant_name" do
    context "assuming one tld" do
      it "should parse subdomain" do
        request = ActionDispatch::Request.new('HTTP_HOST' => 'my.quantum-mx.com')
        expect(elevator.parse_tenant_name(request)).to eq('quantum_my')
      end
